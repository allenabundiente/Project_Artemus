...
CREATE TABLE IF NOT EXISTS guild_messages (
  ...
  -- Strictly-monotonic delivery order for the chat polling cursor. A timestamp
  -- cursor re-delivers the newest message forever (JSON drops Postgres' stored
  -- microseconds — the "chat repeats like a loop" bug); seq gives polling one
  -- exact, gap-free key.
